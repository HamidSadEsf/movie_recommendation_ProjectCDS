...
def cold_starters(amount = 10):
    ...
    it cuts of movies with a rating less than 3.5 and rating amount less than 0.75% of the total of that year. 
    
    Parameters
    ----------
    X:  integer
        The amount of movies to be recommended. If 0 it returns the whole ranked table
        (Default is 10)
    Returns
    ----------
    pandas.Dataframe
    ...
    if amount == 0:
        # returning the ranked table without prefiltering the data
        
        # Normalize the avegerage rating
        ...
        # Normalize realease year to be abel to use it within the normalized score
        ...
        # Droping the unnecesserie columns
        ...
        # returning the a recommendation list with prefiltering the data
